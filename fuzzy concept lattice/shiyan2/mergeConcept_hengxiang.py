...
def main():
    ...
    all_cpt_1 = get_all_cpt(table, a, x_list)
    all_cpt_2 = get_all_cpt(table, b, x_list)
    all_cpt_3 = get_all_cpt(table, c, x_list)
    ...
    for i in range(sort_num):
        combine_concept.append(concept(all_cpt_1[i].X, all_cpt_1[i].Y + all_cpt_2[i].Y))

    output_concept_list(combine_concept)

    print(check_combine_result(combine_concept, all_cpt_3))
