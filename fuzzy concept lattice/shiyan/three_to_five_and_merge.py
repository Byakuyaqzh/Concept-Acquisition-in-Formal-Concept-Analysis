...
def main():
    ...
    #  总结果 5
    x_list_nm = get_all_sort_x(n+m, t5)
    all_cpt_3 = get_all_cpt(table5, c, x_list_nm)

    all_cpt_end_time = time.perf_counter()


    #  测试  3 -> 5
    # all_cpt_1_test = get_all_cpt(table5, a, x_list_n)
    ...
    # print(check_combine_result(all_cpt_1_35, all_cpt_1_test))
